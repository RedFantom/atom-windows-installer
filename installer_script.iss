...
[Registry]
Root: HKCR; Subkey: "*\shell\Atom"; Flags: uninsdeletekey
Root: HKCR; Subkey: "*\shell\Atom\command"; Flags: uninsdeletekey
Root: HKCR; Subkey: "*\shell\Atom"; ValueName: ""; ValueType: string; ValueData: "Open with Atom"; Flags: uninsdeletekey
Root: HKCR; Subkey: "*\shell\Atom"; ValueName: "Icon"; ValueType: string; ValueData: "{app}\atom.exe"; Flags: uninsdeletekey
Root: HKCR; Subkey: "*\shell\Atom\command"; ValueName: ""; ValueType: string; ValueData: "{app}\atom.exe %1"; Flags: uninsdeletekey
